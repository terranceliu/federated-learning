...
if __name__ == '__main__':
    ...
    for user_ix in range(args.num_users):
        ...
        net_local = net_local_list[user_ix]
        if args.iid:
            model_path ='save/{}/mnist_181_iidTrue/user{}.pt'.format(args.results_save, user_ix)
        else:
            model_path ='save/{}/mnist_71_iidFalse/user{}.pt'.format(args.results_save, user_ix)
        net_local.load_state_dict(torch.load(model_path))

    net_local_list.append(copy.deepcopy(net_glob)) # additional model for new device
    ...
    for iter in range(args.epochs):
        ...
        results_save_path = './log/rotated/lglg_{}_C{}_iid{}.npy'.format(
